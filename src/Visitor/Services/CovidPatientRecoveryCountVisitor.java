...
public class CovidPatientRecoveryCountVisitor implements Visitor {
    ...
    private int calculatePatientCount(Hospital hospital) {
        return CalculatePatientCountUtil.calculatePatienteCount(hospital, Disease.COVID, PatientSituation.RECOVER);
    }
