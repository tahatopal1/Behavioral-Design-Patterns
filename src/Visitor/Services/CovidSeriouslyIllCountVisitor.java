...
public class CovidSeriouslyIllCountVisitor implements Visitor {
    ...
    private int calculatePatientCount(Hospital hospital) {
        return CalculatePatientCountUtil.calculatePatienteCount(hospital, Disease.COVID, PatientSituation.SERIOUSLY_ILL);
    }
